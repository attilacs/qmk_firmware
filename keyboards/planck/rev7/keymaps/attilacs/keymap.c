...
tap_dance_action_t tap_dance_actions[] = {
    ...
    // Tap once for Gui, twice for App
    [TD_GUI] = ACTION_TAP_DANCE_DOUBLE(KC_LGUI, KC_APP),
};
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |TDGUI |TDAlt |Leader|Lower |Space | Nums |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    KC_LCTL, TDGUI,   TDALT,   QK_LEAD, LOWER,   KC_SPC,  NUMBERS, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |TDGUI |TDAlt |      |Lower |Space | Nums |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
